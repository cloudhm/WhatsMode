...
public class RegexUtils {
     ...
     * 正则：表情
     */
    public static final String REGEX_EXPRESSION = "\\[[\u4e00-\u9fa5\\w]+\\]";
    ...
    * */
    public static final String REGEX_PWD = "^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,10}$";
    /**
    ...
    public static boolean isJumperMessage(String url) {
        return !TextUtils.isEmpty(url) && url.contains("messenger_commerce_");
    }
}